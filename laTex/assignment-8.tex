...
\author{ U.S.M.M TEJA (CS21BTECH11059)% <-this % stops a space
}	
%\title{
...
\begin{abstract}
This document contains the solution for Assignment 8 (papoulis ch2 problem-2.20) \end{abstract}
%template ends here
\textbf{QUESTION 2.20 :}
...
so there’s
a small square of side length d - 2r in each square where the center can fall 
without the coin extending beyond the grid square.
